      ...
      <div className="flex justify-between m-5">
        <div className="flex items-center justify-center">
          ...
          {selectedImage ? ( // Render selected image if available
            <Image src={selectedImage} alt="selected" width={50} height={55} className=" object-cover w-full h-full"/>
          ) : (
            <Image src={"/imgs/profile.svg"} alt="account" width={50} height={50} />
          )}
          </div>
          <span className="text-center pl-2 font-medium">Kimlang Tieng</span>
        </div>
        <div className="flex h-[35px] items-center  border rounded-2xl p-2 mt-2 hover:bg-gray-200">
