...
Default.args = {
  ...
  caption: 'This is a caption that might be quite long so it can be truncated.',
...
NoImage.args = {
  ...
  hour: 2,
  title: 'Another title',
  caption: 'This is another caption with some more text to show the truncation effect in action.',
  onLike: action('liked'),
  onSave: action('saved'),
};
